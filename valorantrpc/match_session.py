...
class Session:
    ...
    def pregame_loop(self,presence_data):
        ...
        self.client.set_activity(
            ...
            large_image=f"agent_{self.agent_name.lower().replace('/','')}" if (self.agent_name != "?" and self.agent_name != "Observer") else "game_icon_white",
    ...
    def ingame_loop(self,presence_data):
        ...
        self.client.set_activity(
            ...
            large_text=self.map,
            small_image=f"agent_{self.agent_name.lower().replace('/','')}" if self.agent_name != "Observer" else "game_icon_white",
